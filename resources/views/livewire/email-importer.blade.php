        ...
        <x-slot name="form">
           ...
           <div class="col-span-2">
            ...
            <div class="col-span-6">
                ...
                <textarea class="form-input rounded-md shadow-sm mt-1 block w-full" rows="3" wire:model="listing.notes" id="notes"></textarea>
                <x-jet-input-error for="listing.notes" class="mt-2" />
                <input type="hidden" name="" value="{{$this->listing->id}}" id="list_id">
            </div>
